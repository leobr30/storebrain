...
export const formatNumber = (value:number) => (Math.round(value * 100) / 100).toLocaleString()

export const getInitials = (name:string) => name.match(/(\b\S)?/g)!.join("").toUpperCase();

export const REQUIRED = 'Le champ est requis.'
